...
imprimirPacientes(totalPacientes, "lista-total-pacientes")
...
const crearEtiquetaPacientesPorPrevision = (pacientes) =>{
let htmlCode = ''
...
imprimirPacientes(pacientesIsapreDental, "lista-pacientes-isapre-dental")
...
imprimirPacientes(pacientesFonasaTraumatologia, "lista-pacientes-fonasa-traumatologia")
